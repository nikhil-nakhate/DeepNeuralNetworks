...
class Instance {
    ...
    public Instance(BufferedImage image, String fileName, String label) {
        ...
        imageMat3 = new Mat3D(height,width,4);
        ...
        imageMat3.mat3.get(0).setMat(red_channel);
        imageMat3.mat3.get(1).setMat(green_channel);
        imageMat3.mat3.get(2).setMat(blue_channel);
        imageMat3.mat3.get(3).setMat(getGrayImage());
        // Normalize all images
        imageMat3.Normalize(255.0);
    }
